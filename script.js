...
const description = {
    ...
    1: 'Задание 2. Создайте переменную age с указанием возраста в диапазоне от 1 до 100 (включительно) Проверить условия: Если значение попадает в диапазон от 10 до 59 (включительно), вывести: "Вам еще работать и работать"; При значении более 59 - вывести: "Вам пора на пенсию". При значении от 1 до 17 (включительно), вывести: "Вам еще рано работать"',
